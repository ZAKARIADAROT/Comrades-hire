...
const Dashboard = () => {
  ...
  return (
    <div className='min-h-screen'>
        ...
        {/* Dashboard for Recruiter Panel */}
        <div className='shadow py-4'>
            <div className='px-5 flex justify-between items-center'>
                <img onClick={() => navigate('/')} className='cursor-pointer h-24 w-auto' src={NewLogo} alt=''/>
                <div className='flex items-center gap-3'>
                    <p className='max-sm:hidden'>Welcome to smart coders-Tech</p>
                    <div className='relative group'>
                        <img className='w-8 border border-radius-full' src={assets.company_icon} />
