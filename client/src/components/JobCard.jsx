  ...
  return (
    <div className='border p-6 shadow rounded'>
      ...
      <div className='mt-4 flex gap-4 text-sm'>
        <button className='bg-blue-600 text-white px-4 py-2'>Apply Now</button>
        <button className='text-grey-500 border border-grey-500 rounded px-4 py-2'>Learn More</button>
      </div>
    </div>
  )
}
